...
async function submitKP() {
  ...
  const payload = {
    ...
    // Запасні шаблони (якщо галузь не обрана)
    ses_template_no_credit:          settings.ses_template_no_credit          || '',
    ses_template_no_credit_no_img:   settings.ses_template_no_credit_no_img   || '',
    ses_template_with_credit:        settings.ses_template_with_credit        || '',
    ses_template_with_credit_no_img: settings.ses_template_with_credit_no_img || '',
